...
defined('USER_CUSTOMER')           OR define('USER_CUSTOMER','2');
...
defined('NOTIFICATION_IMAGE_PATH') OR define('NOTIFICATION_IMAGE_PATH','./uploads/notifications');
...
defined('APP_NAME') OR define('APP_NAME','Restaurant');
