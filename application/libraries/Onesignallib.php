...
class Onesignallib
{
    ...
    {
        //parent::__construct();
        $one_signal = get_options(array("one_signal_id","one_signal_key"));
        $this->os_key = $one_signal["one_signal_key"];
        $this->os_id = $one_signal["one_signal_id"];
    ...
    function callApi($fields){
        if (isset($this->os_key) && isset($this->os_id) && $this->os_key != null && $this->os_id != null) {
