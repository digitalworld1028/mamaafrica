<?php 
                        ...
                        switch($dt->status){
                            case ORDER_PENDING :
                                if($dt->order_type == "delivery")                               
                                    $action_button[] = "<a href='javascript:assignOrder(\""._encrypt_val($dt->order_id)."\",".$count.")' >"._l("Confirm").'</a>';
                                else
                                    $action_button[] = "<a href='javascript:updateStatus(\"".site_url("admin/orders/updatestatus/"._encrypt_val($dt->order_id))."\",".$count.",".ORDER_CONFIRMED.")' >"._l("Confirm").'</a>';
